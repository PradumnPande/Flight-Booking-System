        ...
        return (
            <div className="container">
                <div className="container text-center">
                    <Jumbotron className="bg-green text-warning jumbotron" style={{marginTop : '30px'}}>
                        <h2><strong>My Profile</strong></h2>
                    </Jumbotron>
                    
                    <FontAwesomeIcon icon={faUser} style = {{fontSize : '122px', color : 'white'}}/>
                </div>
                <br/>
                
                <div>
                    <Card className="container text-center text-white" bg="primary" style={{width : '45%', marginLeft : '295px'}}>
                        <Card.Body>
