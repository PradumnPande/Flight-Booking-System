    ...
    render() {
        return (
            <div className="container">
                <div className="container">                                                        
                    <Card bg="teal" className="text-center text-warning" style={{width : '50%', marginLeft : '260px', marginTop : '20px', paddingTop :'20px', borderRadius : '50px'}}>
                        <Card.Title><h1 style={{fontWeight:'bold'}}><strong>My Bookings</strong></h1></Card.Title>
                    </Card>
                </div>
                ...
                this.state.bookings.map( train =>
                    <Card key={train.pnr} style={{marginTop : '40px', width : "100%"}}>
                                                    ...
                                                    <Card.Footer className='text-center'>
                                                        <small><i>Travel Safe: Use Masks & Sanitizers during travel!</i></small>
                                                    </Card.Footer>
